...
public class WsPollingRetrofitFactory extends TransportFactory {
    ...
    public WsPollingRetrofitFactory(Integer port,String clientNodeId, String hostname, String protocol) {
        this.port = port;
    ...
    public ClientNode getClient(Boolean isMaster) {
        ...
        return new org.eclipse.keyple.example.remote.wspolling.client_retrofit.WsPRetrofitClient(protocol + hostname +":" + port , keypleUrl,
