...
public class RemoteSePlugin extends Observable implements ObservablePlugin {
    ...
    //private final VirtualReaderSessionManager sessionManager;
    ...
    /**
     * Only {@link VirtualReaderService} can instiancite a RemoteSePlugin
     */
    RemoteSePlugin(VirtualReaderSessionManager sessionManager) {
    ...
    protected void disconnectRemoteReader(String nativeReaderName) throws KeypleReaderNotFoundException {
        ...
        if (isReaderConnected(nativeReaderName)) {
            ...
            final VirtualReader virtualReader = (VirtualReader) this.getReaderByRemoteName(nativeReaderName);
    ...
    protected void onReaderEvent(ReaderEvent event, String sessionId) {
        ...
        try {
            ...
            VirtualReader virtualReader = (VirtualReader) getReaderByRemoteName(event.getReaderName());
